...
const Timer02 = () => {
  ...
  return (
    <div className="widget_container" data-variant="timer02">
      <div className="bg-white relative max-w-[500px] min-w-[300px] w-full aspect-[1/1.1] flex flex-col items-center justify-between rounded-3xl shadow-2xl 2xs:p-6 p-8">
        ...
        <div className="w-full flex-1 flex justify-center items-center">
          <div className="bg-black 2xs:max-w-[70%] max-w-[85%] w-full flex items-center justify-between 2xs:py-4 py-3 2xs:px-8 px-5 rounded-xl shadow-xl">
            <div className="timer_time">
              <p className="text-white 2xs:text-[1.5rem] text-[1.2rem]">
            ...
            <div className="timer_btn flex gap-4 items-center">
              <button
                ...
                aria-label="시작"
                disabled={running}
                className="inline-flex items-center justify-center 2xs:text-[2rem] text-[1.5rem] text-white disabled:text-gray-500 disabled:cursor-not-allowed"
              >
