...
const Timer02 = () => {
  ...
  return (
    <div className="widget_container" data-variant="timer02">
      <div className="bg-timer-02-bg relative max-w-[500px] min-w-[300px] w-full aspect-[1/1.1] flex flex-col items-center justify-between rounded-3xl shadow-2xl 2xs:p-6 p-8">
